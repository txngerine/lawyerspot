...
class IpcSectionsScreen extends StatefulWidget {
  const IpcSectionsScreen({super.key});

  @override
  State<IpcSectionsScreen> createState() => _IpcSectionsScreenState();
}

class _IpcSectionsScreenState extends State<IpcSectionsScreen> {
  ...
  Widget build(BuildContext context) {
    final page = _cms.siteContent?.ipcPage;
    final sections = _cms.siteContent?.ipcSections ?? [];

    return Scaffold(
      appBar: BrandAppBar(
        showBack: true,
        title: page?.title.isNotEmpty == true ? page!.title : 'IPC Sections',
      ),
      body: SafeArea(
        top: false,
        child: Obx(() {
  ...
  List<IpcSectionEntry> _filterSections(List<IpcSectionEntry> sections) {
